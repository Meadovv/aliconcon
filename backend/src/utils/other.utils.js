...
class OtherUtils {
    ...
    static generateOrderHTMLContent = ({ name, order }) => {
        return `
        <table
            border="0"
            cellpadding="0"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                                <h2>Dear ${name},</h2>
                                                                                <p>We received your order at Aliconcon E-commerce. Thank you for shopping with us!</p>
                                                                                <p>You can view the details of your order by clicking on the button below:</p>
                                                                                <p>If you made a purchase while logged in, please log in to that account to check your order.</p>
                                                                                <p>Thank you for using Aliconcon E-commerce!</p>
                                                                                <p>Best regards,</p>
                                                                                <p>The Aliconcon Team</p>
                                                                        </p>
                                                                        ...
                                                                        >
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    >
                                                                                        <a
                                                                                            href="https://aliconcon.xyz/tracking?orderId=${order}"
                                                                                            style="
                                                                                                color: #fff;
                                                                                                font-family: Poppins,
                                                                                                    Helvetica, Arial,
